...
module.exports.getProductsList = function(req, res){
	...
	if (counter!==undefined) { /*check if filter for categories was used*/
		...
		categories.forEach(function(category){
			Product.find({'category.id': category}, 'name address quantity isHit isNew image_micro_thumb category', function(err, rep){
		...
		Product.find({isHit: true}, 'name address quantity isHit isNew image_micro_thumb category', function(err, rep){
