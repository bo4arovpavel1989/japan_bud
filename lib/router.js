...
var getRequests = [
	...
	},
	{
		url: '/new-products',
		middleware: noMiddleware,
		callback: getRequestsHandlers.getNewProductPage
	},
	{
	...
	},
	{
		url: '/pay/order/:num',
		middleware: noMiddleware,
		callback: getRequestsHandlers.getPayPage
	},
	{
		url: '/payment/success',
		middleware: noMiddleware,
		callback: getRequestsHandlers.getSuccessPage
	},
	{
		url: '/payment/fail',
		middleware: noMiddleware,
		callback: getRequestsHandlers.getFailPage
	},
	/*components routes*/
	{
		url: '/searchproduct',
...
var postRequests = [
	...
	},
	{
		url: '/admin/makenew',
		middleware: checkAccess,
		callback: postRequestsHandlers.makeNew
	},
	{
